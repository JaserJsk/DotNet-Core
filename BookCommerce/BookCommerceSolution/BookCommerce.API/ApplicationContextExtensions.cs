...
namespace BookCommerce.API
{
    public static class ApplicationContextExtensions
    {
        ...
        public static void EnsureSeedDataForContext(this ApplicationContext context)
        {
            ...
            ReadFileAndPopulateDatabase("./Seeds/xml/books.xml");
        ...
        {
            /*
             * Read JSON data with helper into myFile object.
             */
            //String jsonfile = file;
            //BookFromFile myFile = new Helpers.JSONHelper().JSON_File_To_Object<BookFromFile>(jsonfile);
